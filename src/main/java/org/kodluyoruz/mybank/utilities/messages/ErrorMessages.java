package org.kodluyoruz.mybank.utilities.messages;
...
public class ErrorMessages {
    ...
    public static final String CARD_COULD_NOT_MATCHED_TO_YOUR_ACCOUNT = "Card could not matched to your account.";
    public static final String CARD_PASSWORD_COULD_INCORRECT = "Card password could incorrect.";
    public static final String CUSTOMER_COULD_NOT_DELETED = "Customer could not deleted.";
    public static final String CUSTOMER_COULD_NOT_FOUND = "Customer could not found";
    public static final String CREDIT_CARD_LIMIT_OVER = "Credit card limit over.";
    public static final String EXTRACT_OF_ACCOUNT_COULD_NOT_FOUND = "Extract of account could not found.";
